...
// Inline brand glyphs (simple-icons paths). @remixicon/react was removed:
// its barrel import defeated tree-shaking and shipped the entire 2.4 MB
// icon library in every page's first load.
